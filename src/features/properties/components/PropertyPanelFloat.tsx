 ...
 * 使用绝对定位，确保收起/展开时位置正确
 */
export const PropertyPanelFloat: React.FC<PropertyPanelProps> = ({
  element,
  onPropertyChange,
  disabled = false,
}) => {
  ...
  return (
    <div className="absolute top-0 right-0 h-full flex">
      ...
      <div
        className={cn(
          'relative h-full bg-background border-l border-border shadow-2xl',
      ...
      >
        ...
        <Button
          ...
          className={cn(
            ...
            "h-12 w-6 rounded-r-none rounded-l-md",
